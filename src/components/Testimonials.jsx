      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="relative h-96 md:h-80">
          <AnimatePresence custom={direction} mode="wait">
            ...
            >
              <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-2xl mx-4 border border-blue-100 hover:shadow-xl transition-shadow duration-300">
          ...
          <button
            ...
            className="absolute left-0 md:-left-12 top-1/2 transform -translate-y-1/2 bg-white p-3 rounded-full shadow-lg border border-blue-100 cursor-pointer hover:bg-blue-50 transition-all duration-300 hover:scale-110"
          ...
          <button
            ...
            className="absolute right-0 md:-right-12 top-1/2 transform -translate-y-1/2 bg-white p-3 rounded-full shadow-lg border border-blue-100 cursor-pointer hover:bg-blue-50 transition-all duration-300 hover:scale-110"
