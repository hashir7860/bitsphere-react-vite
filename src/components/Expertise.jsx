  ...
  return (
    <section className="bg-white py-28 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="text-sm font-medium tracking-wider text-[#00A6FF] mb-2 block">
            OUR CAPABILITIES
          </span>
        ...
        <div className="relative group">
          ...
          <motion.button
            ...
            className="absolute -left-7 top-1/2 -translate-y-1/2 z-20 bg-white p-3 rounded-full shadow-lg border border-[#00A6FF] hover:bg-[#00A6FF] hidden cursor-pointer lg:flex items-center justify-center transition-all duration-300 opacity-0 group-hover:opacity-100"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
          >
            <ChevronLeft className="text-[#00A6FF] h-6 w-6" />
          </motion.button>

          <motion.button
            onClick={() => scrollCards("right")}
            className="absolute -right-7 top-1/2 -translate-y-1/2 z-20 bg-white p-3 rounded-full shadow-lg border border-[#00A6FF] hover:bg-[#00A6FF] hidden cursor-pointer lg:flex items-center justify-center transition-all duration-300 opacity-0 group-hover:opacity-100"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
          >
            <ChevronRight className="text-[#00A6FF] h-6 w-6" />
          </motion.button>
